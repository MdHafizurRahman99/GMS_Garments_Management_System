    ...
    <div class="page-content">
        <div class="wizard-v4-content">
            <div class="wizard-form">
                ...
                <form class="form-register" id="myForm" action="{{ route('permission.store') }}" method="post">
                    @csrf
                    <div id="form-total">
                        <h2>
                            ...
                            <div class="inner">
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="group_name" name="group_name"
                                        value="{{ old('group_name') }}" class="form-control"
                                        placeholder="Enter Group Name/ Feature Name">
                                    <p>(add,edit,delete,view) will autometacily create.
                                    </p>
                                    @error('group_name')
