...
<head>
    <meta charset="utf-8">
    <title>Edit Business Profile Information</title>
...
<body>
        ...
        <div class="wizard-v4-content">
            <div class="wizard-form">
                <div class="wizard-header">
                    ...
                    <h3 class="heading">Edit Business Profile</h3>
                    <p>Edit Business Profile Informations </p>
                </div>

                <form class="form-register" id="myForm"
                    action="{{ route('business.update', ['business' => $business->id]) }}" method="post">
                    @method('PUT')
                    @csrf
                    <div id="form-total">
                            ...
                            <div class="inner">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="company_type" name="company_type"
                                        value="{{ old('company_type', $business->company_type ?? '') }}"
                                        class="form-control" placeholder="Company Type">
                                    @error('company_type')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="business_number">Australian Business Number(ANB)</label>
                                        <input required type="text" id="business_number" name="business_number"
                                            value="{{ old('business_number', $business->business_number ?? '') }}"
                                            class="form-control" placeholder="Enter Australian Business Number">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required type="text" id="company_number" name="company_number"
                                            value="{{ old('company_number', $business->company_number ?? '') }}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required type="tel" id="phone" name="phone"
                                            value="{{ old('phone', $business->phone ?? '') }}" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required type="tel" id="fax" name="fax"
                                            value="{{ old('fax', $business->fax ?? '') }}" class="form-control"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" value="{{ old('mobile_iso2') }}" id="mobile_iso2"
                                            name="mobile_iso2">
                                        <input required type="tel" id="mobile" name="mobile"
                                            value="{{ old('mobile', $business->mobile ?? '') }}" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required type="email" id="email" name="email"
                                            value="{{ old('email', $business->email ?? '') }}" class="form-control"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="physical_street"
                                                value="{{ old('physical_street', $business->physical_street ?? '') }}"
                                                name="physical_street" class="form-control"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="physical_city"
                                                value="{{ old('physical_city', $business->physical_city ?? '') }}"
                                                name="physical_city" class="form-control"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="physical_state"
                                                value="{{ old('physical_state', $business->physical_state ?? '') }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="physical_postal_code"
                                                value="{{ old('physical_postal_code', $business->physical_postal_code ?? '') }}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="physical_country"
                                                ...
                                                value="{{ old('physical_country', $business->physical_country ?? '') }}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="postal_street"
                                                value="{{ old('postal_street', $business->postal_street ?? '') }}"
                                                name="postal_street" class="form-control"
                                                placeholder="Enter Street ">
                                            @error('postal_street')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="postal_city"
                                                value="{{ old('postal_city', $business->postal_city ?? '') }}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="postal_state"
                                                value="{{ old('postal_state', $business->postal_state ?? '') }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="postal_postal_code"
                                                value="{{ old('postal_postal_code', $business->postal_postal_code ?? '') }}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" id="postal_country" name="postal_country"
                                                value="{{ old('postal_country', $business->postal_country ?? '') }}"
                                                class="form-control" placeholder="Enter Country ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" id="accountants_number" name="accountants_number"
                                        value="{{ old('accountants_number', $business->accountants_number ?? '') }}"
                                        class="form-control" placeholder="Enter number of accountants.">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="software_name" name="software_name"
                                        value="{{ old('software_name', $business->software_name ?? '') }}"
                                        class="form-control" placeholder="Enter software name.">
                                    @error('software_name')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="api_key" name="api_key"
                                        value="{{ old('api_key', $business->api_key ?? '') }}"" class="form-control"
    ...
    <script>
        $(document).ready(function() {
            ...
            function getSelectedCountryDataPhone() {
